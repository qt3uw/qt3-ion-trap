...
plt.savefig('figures/figure_5/COMSOLShuttleGraph.pdf', format='pdf', bbox_inches='tight')
...
plt.savefig('figures/figure_5/COMSOLSplitGraph.pdf', format='pdf', bbox_inches='tight')
